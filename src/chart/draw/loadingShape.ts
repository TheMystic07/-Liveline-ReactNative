/**
 * Shared squiggly line shape and breathing alpha — identical to upstream.
 * Used by both loading state and chart morph transition.
 */
...
/** Breathing alpha for the loading line. */
