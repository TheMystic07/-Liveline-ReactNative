/**
 * Badge shape generation — identical to upstream.
 * SVG path data for the badge pill + curved tail.
 */
...
/**
 * Generate SVG path for badge pill + curved tail.
 * Coordinate system: (0,0) is top-left of the shape bounding box.
 * Total size: (tailLen + pillW) x pillH.
